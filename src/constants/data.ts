...
import cvWebInteractifImage from "../assets/images/resume_banner.png";
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    endDate: "",
    description: "Poste polyvalent en restauration rapide",
    achievements: [
...
export const education: Education[] = [
  {
    ...
    endDate: "En cours",
    description:
      "Formation avancée en architecture logicielle et conception de systèmes",
  },
  {
    id: "edu-2",
...
export const projects: Project[] = [
  {
    ...
    image: cvWebInteractifImage,
    previewImages: [cvWebInteractifImage],
    highlights: [
